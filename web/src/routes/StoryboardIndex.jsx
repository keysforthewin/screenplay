...
export function StoryboardIndex() {
  ...
  if (error) {
    return (
      <div className="app">
        <div className="error-banner">Could not load storyboards: {error}</div>
      </div>
    );
  }
  ...
  const beats = [...(toc.beats || [])]
    ...
    .map((b) => ({
      ...
      missing: !b.storyboard_count,
      count: b.storyboard_count || 0,
    }))
  ...
  return (
    <main className="app">
      ...
      <h1 style={{ marginBottom: 8 }}>Storyboards</h1>
