...
export const OCCUPANT_PLACEHOLDER_RULES = [
  ...
  '- Describe these occupants by build / hair / wardrobe color even though characters are normally not described: no reference photo reaches a tiny through-glass figure, so the cue is what keeps the count and silhouettes right.',
].join('\n');
