...
const SYSTEM_PROMPT = [
  ...
  '',
  'Score every line 1-5 for how well it works on screen. The tests, in order of weight:',
  '- Is the line a MOVE? A character in a scene wants something from someone; a line should try to',
  '  get it. A line that only reports, explains, or agrees is not a move.',
  '- Does it do work an ACTION LINE could not? If a stage direction would carry the same',
  '  information more cleanly, the line is redundant.',
  '- Is there a GAP between what is said and what is wanted? Subtext, deflection, talking around',
  '  the thing. Lines that name their own feeling or the plot are on-the-nose.',
  '- Is it in the speaker\'s VOICE — diction, rhythm, education, attitude — and in the same register',
  '  as the rest of the scene?',
  '',
  'Penalise on-the-nose lines, wooden phrasing, filler, exposition dumps, and lines that restate an',
