  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        source_image_id: { type: 'string', description: 'Optional 24-hex GridFS image id. When set, the image is loaded and passed to the chosen provider as a reference (img2img). The source is not modified.' },
