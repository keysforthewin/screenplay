...
Across every body-reference view, the character must wear the costume documented in the OUTFIT / ARMOR section together with the items from the ACCESSORIES / PROPS section. The costume must remain identical (silhouette, layers, colors, fastenings, asymmetric details, accessories) across all views — this is mandatory and non-negotiable. Never depict the character nude, partially nude, topless, or in underwear, even when documenting proportions or anatomy. Costume detail panels can isolate specific garments, attachments, or props for callouts, but the orthographic and pose views must show the character fully clothed in this same costume.`;
